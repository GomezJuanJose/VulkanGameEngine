...
echo "assets/shaders/Builtin.MaterialShader.frag.glsl -> assets/shaders/Built.MaterialShader.frag.spv"
...
echo "assets/shaders/Builtin.UIShader.frag.glsl -> assets/shaders/Built.UIShader.frag.spv"
...
echo "assets/shaders/Builtin.SkyboxShader.frag.glsl -> assets/shaders/Built.SkyboxShader.frag.spv"
