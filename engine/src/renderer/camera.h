 ...
 */
TAPI vec3 camera_position_get(const camera* c);
 ...
 */
TAPI void camera_position_set(camera* c, vec3 position);
 ...
 */
TAPI vec3 camera_rotation_euler_get(const camera* c);
 ...
 */
TAPI void camera_rotation_euler_set(camera* c, vec3 rotation);
 ...
 */
TAPI vec3 camera_forward(camera* c);
 ...
 */
TAPI vec3 camera_backward(camera* c);
 ...
 */
TAPI vec3 camera_left(camera* c);
 ...
 */
TAPI vec3 camera_right(camera* c);
 ...
 */
TAPI void camera_move_forward(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
TAPI void camera_move_backward(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
TAPI void camera_move_left(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
TAPI void camera_move_right(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
TAPI void camera_move_up(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
TAPI void camera_move_down(camera* c, f32 amount);
 ...
 */
TAPI void camera_yaw(camera* c, f32 amount);
 ...
 * @param amount The amount to adjust by.
 */
TAPI void camera_pitch(camera* c, f32 amount);