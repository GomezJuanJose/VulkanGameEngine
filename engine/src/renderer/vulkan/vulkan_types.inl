...
typedef struct vulkan_material_shader_global_ubo {
    ...
    mat4 view;          // 64 bytes
    mat4 m_reserved0;   // 64 bytes, reservered for future use
    mat4 m_reserved1;   // 64 bytes, reservered for future use
...
/**
 * @brief Vulkan-specific uniform buffer for the ui shader.
 */
