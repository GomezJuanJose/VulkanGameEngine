 ...
 * @param get_extended Indicates wheter to also return an extended result.
...
/**
 * Inticates if the passed result is a success or and error as defined by he Vulkan spec.
