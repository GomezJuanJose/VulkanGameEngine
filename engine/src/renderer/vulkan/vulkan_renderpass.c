...
void vulkan_renderpass_create(
    ...
    // If going to another pass, use VK_IMAGE_LAYOUT_COLOR ATTACHMENT_OPTIMAL. Otherwise VK_IMAGE_LAYOUT_PRESENT_SRC_KHR
...
void vulkan_renderpass_begin(
    ...
    if(do_clear_colour){
        tcopy_memory(clear_values[begin_info.clearValueCount].color.float32, renderpass->clear_colour.elements, sizeof(f32) * 4);
