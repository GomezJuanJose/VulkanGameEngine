...
/**
 * @brief Creates a new dynamic allocator. Should be called witce; once to obtain the memry
 * amount required (passing memory=0), and a second time with memory being set to an allocate block.
 * 
 ...
 */
TAPI b8 dynamic_allocator_create(u64 total_size, u64* memory_requirement, void* memory, dynamic_allocator* out_allocator);
 ...
 * @return True on success; otherwise false.
 */
TAPI b8 dynamic_allocator_destroy(dynamic_allocator* allocator);
 ...
 */
TAPI void* dynamic_allocator_allocate(dynamic_allocator* allocator, u64 size);
 ...
 * @return True on success; otherwise false.
 */
TAPI b8 dynamic_allocator_free(dynamic_allocator* allocator, void* block, u64 size);
 ...
 */
TAPI u64 dynamic_allocator_free_space(dynamic_allocator* allocator);